    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('E-posta başarıyla doğrulandı. Şimdi giriş yapabilirsiniz.')),
        );
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.mark_email_read_rounded, size: 64, color: Theme.of(context).colorScheme.primary),
            ...
            ElevatedButton(
              ...
              child: _isLoading
                  ...
                  : const Text('Doğrula', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
            ),
          ],
        ),
      ),
